...
from grampc_s.distributions import GaussianDistribution, MultivariateDistribution, UnivariateUniformDistribution
...
from grampc_s_mobile_robot import MobileRobotWithParametersProblem
...
if __name__ == "__main__":
    ...
    problem = MobileRobotWithParametersProblem(pSys, pCost, pCon)
    ...
    point_transformation = UnscentedTransformation(Nx+Np, Nx, 1, 2, 0, [False, False, False, True, True])
    ...
    for i, t in enumerate(vec.t):
        ...
        initial_state.set_mean_and_covariance(next_state, np.zeros((Nx, Nx)))
