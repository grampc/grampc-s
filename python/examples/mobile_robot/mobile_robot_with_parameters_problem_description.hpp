...
#ifndef MOBILE_ROBOT_WITH_PARAMETERS_PROBLEM_DESCRIPTION_HPP
#define MOBILE_ROBOT_WITH_PARAMETERS_PROBLEM_DESCRIPTION_HPP

#include "problem_description.hpp"

using namespace grampc;

class MobileRobotWithParametersProblemDescription : public ProblemDescription
{
public:
    MobileRobotWithParametersProblemDescription(const std::vector<typeRNum>& pSys, const std::vector<typeRNum>& pCost, const std::vector<typeRNum>& pCon);
...
#endif // MOBILE_ROBOT_WITH_PARAMETERS_PROBLEM_DESCRIPTION_HPP