...
## Dependencies
GRAMPC-S depends on the [Eigen 3.4 library](https://eigen.tuxfamily.org). If Eigen is not installed on your system, clone the repository, create the folder *build*, and install Eigen. For **Linux**, execute the following commands:
```
